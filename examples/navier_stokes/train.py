...
def read_data_fn(root_path):
    ...
    return pinnstorch.data.PointCloudData(spatial = [x, y],
                                          time = [t], 
...
def pde_fn(outputs, x, y, t, extra_variables):
    ...
    outputs['f_u'] = u_t + extra_variables['l1'] * \
                     (outputs['u'] * u_x + outputs['v'] *u_y) + \
                     p_x - extra_variables['l2'] * (u_xx + u_yy) 
    
    outputs['f_v'] = v_t + extra_variables['l1'] * \
                     (outputs['u'] * v_x + outputs['v'] *v_y) + \
                     p_y - extra_variables['l2'] * (v_xx + v_yy)
